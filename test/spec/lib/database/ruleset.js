  ...
  describe("#root", function() {
    ...
    describe("#$traverse", function() {
      ...
      it("should yield wildchild nodes on its path", function() {
        ...
        expect(cb).to.have.been.calledWith("", rules.root, {});
        expect(cb).to.have.been.calledWith("a", rules.root.a, {});
        expect(cb).to.have.been.calledWith("a/foo", rules.root.a.$wildchild, {
          $b: "foo"
        });
        expect(cb).to.have.been.calledWith(
          "a/foo/bar",
          rules.root.a.$wildchild.$wildchild,
          { $b: "foo", $c: "bar" }
        );
      ...
      it("should extend wildchildren list", function() {
        ...
        expect(cb).to.have.been.calledWith("", rules.root.a.$wildchild, {
          $b: "foo"
        });
        expect(cb).to.have.been.calledWith(
          "bar",
