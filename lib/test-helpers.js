...
exports.writableError = function(result, newData) {

  var msg = 'Expected ' + getUserDescription(result.auth) +
    ' not to be able to write ' + JSON.stringify(newData) +
    ' to ' + result.path +
...
exports.unwritableError = function(result, newData) {

  var msg = 'Expected ' + getUserDescription(result.auth) +
    ' to be able to write ' + JSON.stringify(newData) +
    ' to ' + result.path +
